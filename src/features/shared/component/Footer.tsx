  ...
  return (
    <footer className="bg-slate-900 text-white">
      ...
      <div className="bg-white">
        <svg viewBox="0 0 1440 65" preserveAspectRatio="none" className="w-full text-slate-900 -mb-1" fill="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          {/* Navigation Links */}
          <nav className="my-8 flex justify-center gap-6 sm:gap-8" aria-label="Footer">
            <a href="/#" className="text-base leading-6 text-gray-300 hover:text-white">Home</a>
            <a href="/about" className="text-base leading-6 text-gray-300 hover:text-white">About</a>
            <a href="/products" className="text-base leading-6 text-gray-300 hover:text-white">Products</a>
          </nav>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-center">
          <p className="text-base text-gray-400">&copy; {currentYear} Artspace. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
